...
TEST(YardTest, lambda){
        ...
        Pet * pet1 = new Dog("Dog1", 30);
        Pet * pet2 = new Dog("Dog2", 40);
        Pet * pet3 = new Cat("Cat1", 4);
        Pet * pet4 = new Cat("Cat2", 3.5);
        total.push_back(pet1);
        total.push_back(pet2);
        total.push_back(pet3);
        total.push_back(pet4);
        Yard yard(total);
